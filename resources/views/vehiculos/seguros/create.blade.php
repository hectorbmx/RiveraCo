...
@section('title', 'Registrar póliza de vehículo')
...
<div class="w-full space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">Ingresa los datos del seguro asociados a este vehículo.</p>
        </div>
        <a
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    <div>
                        ...
                        <input type="text" name="aseguradora" value="{{ old('aseguradora') }}" class="w-full text-sm border-slate-300 rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all" required placeholder="Ej. GNP, AXA...">
                    </div>

                    <div>
                        <label class="block text-xs font-medium text-slate-700 mb-1.5">Número de póliza <span class="text-red-500">*</span></label>
                        <input type="text" name="poliza_numero" value="{{ old('poliza_numero') }}" class="w-full text-sm border-slate-300 rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all" required placeholder="Nº de contrato/póliza">
                    </div>

                    <div>
                        <label class="block text-xs font-medium text-slate-700 mb-1.5">Tipo de seguro</label>
                        <input type="text" name="tipo_seguro" value="{{ old('tipo_seguro') }}" class="w-full text-sm border-slate-300 rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all" placeholder="Ej. Cobertura Amplia">
                    </div>

                    <div>
                        <label class="block text-xs font-medium text-slate-700 mb-1.5">Método de pago</label>
                        <input type="text" name="metodo_pago" value="{{ old('metodo_pago') }}" class="w-full text-sm border-slate-300 rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all" placeholder="Ej. Transferencia, Tarjeta">
                    </div>

                    <div>
                        <label class="block text-xs font-medium text-slate-700 mb-1.5">Costo</label>
                        <input type="number" step="0.01" name="costo" value="{{ old('costo') }}" class="w-full text-sm border-slate-300 rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all" placeholder="0.00">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="suma_asegurada" value="{{ old('suma_asegurada') }}" class="w-full text-sm border-slate-300 rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all" placeholder="0.00">
                    </div>

                    <div>
                        <label class="block text-xs font-medium text-slate-700 mb-1.5">Deducible</label>
                        <input type="number" step="0.01" name="deducible" value="{{ old('deducible') }}" class="w-full text-sm border-slate-300 rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all" placeholder="0.00">
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    <div>
                        ...
                        <input type="date" name="fecha_compra" value="{{ old('fecha_compra') }}" class="w-full text-sm border-slate-300 rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all">
                    </div>

                    <div>
                        <label class="block text-xs font-medium text-slate-700 mb-1.5">Vigencia desde <span class="text-red-500">*</span></label>
                        <input type="date" name="vigencia_desde" value="{{ old('vigencia_desde') }}" class="w-full text-sm border-slate-300 rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all" required>
                    </div>

                    <div>
                        <label class="block text-xs font-medium text-slate-700 mb-1.5">Vigencia hasta <span class="text-red-500">*</span></label>
                        <input type="date" name="vigencia_hasta" value="{{ old('vigencia_hasta') }}" class="w-full text-sm border-slate-300 rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all" required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 pt-2">
                    <div>
                        ...
                        <textarea name="cobertura" rows="3" class="w-full text-sm border-slate-300 rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all" placeholder="Detalles de la cobertura...">{{ old('cobertura') }}</textarea>
                    </div>

                    <div>
                        <label class="block text-xs font-medium text-slate-700 mb-1.5">Observaciones</label>
                        <textarea name="observaciones" rows="3" class="w-full text-sm border-slate-300 rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all" placeholder="Notas adicionales o comentarios...">{{ old('observaciones') }}</textarea>
                    </div>
                </div>
            </div>
