...
public function show(Request $request, Obra $obra, AsistenciaResumenService $asistenciaResumen)
{
    ...
    return response()->json([
        ...
        'data' => [
            ...
            'asistencia_hoy' => $asistenciaResumen->resumenDiarioObra((int) $obra->id, $request->query('date')),
