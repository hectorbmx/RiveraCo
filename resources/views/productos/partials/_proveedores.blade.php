                    ...
                    <td class="px-4 py-2" colspan="6">
                        <form method="POST"
                            ...
                            <div class="flex justify-end gap-2">
                                <button class="px-3 py-1 rounded-xl text-sm bg-[#0B265A] text-white hover:opacity-90">
                                    Guardar
                                </button>
                                ...
                                <form method="POST"
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button class="px-3 py-1 rounded-xl text-sm border border-slate-200 text-slate-600 hover:bg-slate-50">
                                        Quitar
                                    </button>
                                </form>
                            </div>
